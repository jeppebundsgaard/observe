...
<footer class="footer d-print-none py-1 mt-auto site-footer fixed-bottom-md">
	...
	<div class="row ">
		<div class="col ">
			<a class="footer-link" href="?create=1"><span class="text-muted ml-2">&copy; Observe.education</span></a>
		</div>
...
<script src="./js/vendor/bootstrap4-toggle.min.js"></script>


<script>var language="<?=$locale;?>"</script>
<script src="./js/basesystem.js?v=<?=$v;?>"></script>
<script src="./js/observe.js?v=<?=$v;?>"></script>
<?php 
if($_SESSION["user_id"]) echo('<script src="./js/basesystemadmin.js?v='.$v.'"></script><script src="./js/observeadmin.js?v='.$v.'"></script>');
?>
