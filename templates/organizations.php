		...
		<table class="table table-sm table-hover mt-2">
			...
			<?php
				while($r=$result->fetch_assoc()) { ?>
					<tr><td><?= $r["orgname"];?></td><td><?= $r["orgslogan"];?></td><td><?= $r["orgurl"];?></td><td><button type="button" class="btn btn-primary btn-small editorgusers" data-org_id="<?= $r["org_id"];?>"><?= _('Users');?></button></td><td><button type="button" class="btn btn-danger btn-small removeorg" data-org_id="<?= $r["org_id"];?>"><?= _('Remove');?></button></td><tr>
			<?php	}
			?>
			</tbody>
		</table>
