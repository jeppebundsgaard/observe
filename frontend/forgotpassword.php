...
// 	$log.=$link;
	...
	try {
		...
		$mail->Body    = sprintf(_('Hello %1$s,<br>Someone asked for a new password for Observe. If it was not you, please disregard this e-mail.<p>Please click on this link to create a new password:</p><p><a href="%2$s">%2$s</a></p>'),$r["username"],$link);
